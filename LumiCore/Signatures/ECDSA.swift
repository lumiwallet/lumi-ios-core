...
public struct EdDSAfunctions {

    /// Signature using EdDSA Donna
    /// - Parameters:
    ///   - data: Input message (32 bytes long hash expected)
    ///   - key: Private key data
    public static func signDonna(data: Data, key: Data) -> Data {
    ...
    public static func validateDonna(signature: Data, data: Data, for key: Data) -> Bool {
